...
| run_external_runtime_gpu_qualification | experimental | scripts/run_external_runtime_gpu_qualification.sh | Install pinned YOLOX and OpenMMLab runtimes and execute all non-dry training lanes on a compatible Linux CUDA host while retaining structured failures. |
