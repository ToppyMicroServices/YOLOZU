...
| eval_coco | stable | tools/eval_coco.py | Strictly validate and evaluate predictions on a YOLO-format dataset using COCOeval, with explicit repair and bounded-subset accounting; --dry-run does not require pycocotools. |
