...
| prepare_external_runtime_smoke_datasets | experimental | tools/prepare_external_runtime_smoke_datasets.py | Prepare bounded COCO detection, COCO keypoint, and Cityscapes-style segmentation layouts for runtime availability tests, with heuristic labels explicitly marked non-efficacy GT. |
