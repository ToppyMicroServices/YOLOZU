...
| run_mcp_server | stable | tools/run_mcp_server.py | Run the YOLOZU MCP stdio server, expose canonical live tool ids, and inspect filtered packaged-manifest discovery plus the guaranteed AI-safe/config-review/Actions surface sets. |
