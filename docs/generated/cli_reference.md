...
| qualify_sdft_continual | research | tools/qualify_sdft_continual.py | Qualify the repository's checkpoint-distillation continual lane against naive sequential fine-tuning across three fixed seeds, real COCOeval, identical data/order/budget, preregistered non-zero gates, and an optional independent reproduction. |
