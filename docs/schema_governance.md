...
| Research reports | `docs/schemas/research_lane_report.schema.json`, `docs/schemas/artifact_research_qualification.schema.json`, `docs/schemas/research_note.schema.json` | [`research_lanes.md`](research_lanes.md), [`research_note_template.md`](research_note_template.md) | Research results stay separate from stable evaluation reports; artifact qualification requires three repetitions and an explicit promotion gate. |
