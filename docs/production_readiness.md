...
| BOP T-LESS object 6DoF | Research | Safe acquisition/conversion and diagnostic frame-holdout orchestration are implemented; no release-addressable baseline-versus-trained, three-seed real result establishes efficacy. This is rigid-object pose, not human 3D skeleton pose. | [`bop_tless_protocol.md`](bop_tless_protocol.md), [`../reports/bop_pose_readiness_2026-07-28.md`](../reports/bop_pose_readiness_2026-07-28.md), `manual/chapters/16_depth_6dof_symmetry.tex` |
...
| Training platform | Stable reference interface + environment-qualified external execution | RT-DETR pose is the richest in-repo path. External lanes share a standardized run bundle, but real training requires the backend runtime/launcher. The tracked multi-task fixture has heuristic keypoint/depth/pose6d labels and lacks task-native before/after metrics, so training quality remains unqualified. | [`training_backend_interface.md`](training_backend_interface.md), [`training_capability_matrix.md`](training_capability_matrix.md), [`training_orchestration.md`](training_orchestration.md), [`external_finetune_smoke.md`](external_finetune_smoke.md) |
