...
| BOP T-LESS object 6DoF | Research | Real CC-BY-4.0 T-LESS acquisition, strict GT, three-seed baseline/trained task-native evaluation, and independent semantic reproduction are complete. Metrics remain zero/null because no pose predictions matched, and the diagnostic frame holdout is not the official BOP test. This is rigid-object pose, not human 3D skeleton pose. | [`bop_tless_protocol.md`](bop_tless_protocol.md), [`../reports/bop_tless_evidence_2026-07-30.md`](../reports/bop_tless_evidence_2026-07-30.md), `manual/chapters/16_depth_6dof_symmetry.tex` |
...
| Training platform | Stable reference interface + environment-qualified external execution | RT-DETR pose is the richest in-repo path. Strict T-LESS GT now covers task-native before/after evidence. Ultralytics, HF DETR, and Detectron2 completed real training in two environments; five other external lanes remain unavailable on the tested host. Zero/null bounded metrics keep training quality unqualified. | [`training_backend_interface.md`](training_backend_interface.md), [`training_capability_matrix.md`](training_capability_matrix.md), [`training_orchestration.md`](training_orchestration.md), [`external_finetune_smoke.md`](external_finetune_smoke.md), [`../reports/external_runtime_evidence_2026-07-30.md`](../reports/external_runtime_evidence_2026-07-30.md) |
