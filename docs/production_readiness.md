...
| Environment-qualified adaptive local vision | Future delivery; target maturity is Experimental | The v1 policy governs future recommendation and execution. The current release claims neither capability. Public selection requires exact environment, workload, protocol, support-profile, and active trusted-evidence matches; site-qualified selection remains local to that site. Otherwise the router abstains. | [`adaptive_image_routing.md`](adaptive_image_routing.md), [`../reports/adaptive_vision_roadmap.md`](../reports/adaptive_vision_roadmap.md), [`../yolozu/data/manifest/adaptive_vision_roadmap.json`](../yolozu/data/manifest/adaptive_vision_roadmap.json), [`roadmap.md`](roadmap.md) |
...
[`adaptive_image_routing.md`](adaptive_image_routing.md) is the normative v1 policy for later interface contracts and implementation. It is not implementation, availability, or qualification evidence.
