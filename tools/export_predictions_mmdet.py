...
def _parse_args(argv):
    parser = argparse.ArgumentParser(description="Run MMDetection inference and export YOLOZU predictions.json.")
    ...
    parser.add_argument("--checkpoint", required=True, help="MMDetection checkpoint path")
    ...
    parser.add_argument("--device", default="cuda:0", help="MMDetection model device")
    ...
    parser.add_argument("--resize-policy", default="config_resize", help="Resize policy metadata")
    parser.add_argument("--pad-policy", default="config_pad", help="Pad policy metadata")
    parser.add_argument("--dry-run", action="store_true", help="Write schema-valid output without MMDetection runtime")
...
def main(argv=None) -> int:
    ...
    meta["extra"] = {
        ...
        "export_settings": {
            ...
            "preprocessing": {
                "source": "mmdetection_config_pipeline",
