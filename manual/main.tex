...
designed to support reproducible continual learning and test-time adaptation (TTT) under \textbf{domain shift}.

\yolozu{} helps mitigate \textbf{catastrophic forgetting} by enabling reproducible workflows
...
\textbf{\yolozu{} exists to measure, compare, and control catastrophic forgetting
