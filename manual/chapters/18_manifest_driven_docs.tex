...
Chapter~12 explains how users and automation discover declared tools from the
...
\begin{itemize}
  ...
  \item Interface contract claims strictly match the \texttt{contracts.consumes} and \texttt{contracts.produces} specifications.
\end{itemize}

\section{Understanding Manifest Capabilities}
The manifest is not merely a list of scripts; it is a declarative governance tool. Chapter~12 covers day-to-day discovery. In this chapter, inspect \path{tools/manifest.json} to decide what must be updated when behavior changes:
\begin{itemize}
...
\begin{itemize}
  ...
  \item Registry, interface contract metadata, and governance changes: Chapter 12 and this chapter
\end{itemize}
