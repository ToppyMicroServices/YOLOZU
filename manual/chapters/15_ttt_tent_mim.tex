...
MIM & \path{reports/ttt_compare/mim_smoke_cpu} & planning only on the shipped checkpoint & n/a & n/a & requires a MIM-enabled checkpoint/config \\
...
On the repo-shipped checkpoint, \cmd{mim} remains useful as a boilerplate and
