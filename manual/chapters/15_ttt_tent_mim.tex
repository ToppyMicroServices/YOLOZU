...
\node[box, right=14mm of s0] (s1) {adapt\\(bounded)};
...
\node[box, right=14mm of p0] (p1) {adapt\\(per image)};
...
\node[box, above=6mm of s1] (lbls) {\textbf{stream}};
\node[box, above=6mm of p1] (lblp) {\textbf{sample}};
