...
\begin{itemize}
  ...
  \item \textbf{Container workflow expectations}: \path{.github/workflows/container.yml} now builds container-related pull requests for early validation, while image publication remains gated to tag/manual runs.
