...
\begin{itemize}
  ...
  \item \textbf{SynthGen Intake Contract}: \path{docs/contracts/synthgen.md}
\end{itemize}
...
The intake boundary is fixed by \path{docs/contracts/synthgen.md}, with required fields such as \cmd{image}, \cmd{depth\_ndc}, \cmd{inst\_id}, \cmd{sem\_id}, and \cmd{kpts2d}.
