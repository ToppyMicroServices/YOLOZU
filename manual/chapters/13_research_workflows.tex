...
\begin{itemize}
  ...
  \item \cmd{teacher_min_score}
  \item \cmd{max_added_per_image}
  \item \cmd{add_duplicate_iou_threshold}
\end{itemize}
...
\begin{itemize}
  ...
  \item This is a score-level / label-free helper, intended for fast ablations. For safer practical usage, set a non-zero \cmd{teacher_min_score}, set finite \cmd{max_added_per_image}, and keep \cmd{add_duplicate_iou_threshold} high to avoid duplicate amplification.
