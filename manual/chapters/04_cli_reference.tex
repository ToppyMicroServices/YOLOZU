...
Train orchestration & \path{reports/train_orchestration_spec.json} & \cmd{yolozu train-orchestrate --spec <spec.json> --output reports/training\_orchestration\_report.json} \\
