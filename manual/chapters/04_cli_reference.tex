...
\cmd{bash scripts/smoke.sh --help} & Shows smoke CLI options (\cmd{--dataset}, \cmd{--predictions}, \cmd{--report}, \cmd{--synthgen-root}, \cmd{--synthgen-predictions}, \cmd{--output-dir}, \cmd{--demo-run-dir}, \cmd{--skip-demo}, \cmd{--profile}, \cmd{--walkthrough-report}). \\
...
\cmd{bash release.sh} & Runs no-option release automation: auto version bump policy, tag push, GitHub release publish, and PyPI/Zenodo workflow handoff. \\
