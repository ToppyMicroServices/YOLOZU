...
\cmd{bash scripts/ttt\_compare.sh} & Short baseline-vs-adapted TTT compare wrapper. Use \cmd{--boilerplate tent|mim|cotta|eata|sar} plus \cmd{--dataset}, \cmd{--checkpoint}, and \cmd{--run-dir}; it writes baseline/adapted predictions and a before-after Markdown+JSON summary. \\
