...
\cmd{python3 tools/run\_reference\_adapter\_regression.py} & Runs RT-DETR reference-adapter regression with contract gates (hard) and behavior gates (warn/hard), including reproducibility metadata. \\
