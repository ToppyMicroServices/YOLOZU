...
\cmd{yolozu train} & Initiates YAML/JSON config-driven RT-DETR training by default. With \cmd{--external-backend yolox}, it switches to the Apache-2.0-friendly external YOLOX bridge while keeping the same top-level train surface. \\
