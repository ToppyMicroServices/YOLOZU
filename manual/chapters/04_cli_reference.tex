...
\cmd{yolozu export-dataset yolo|kitti} & Exports a YOLOZU dataset wrapper into a standalone YOLO training layout (\path{data.yaml} + \path{images/}/\path{labels/}) or a KITTI-style layout (\path{image\_2}/\path{label\_2}/\path{ImageSets/Main}). \\
