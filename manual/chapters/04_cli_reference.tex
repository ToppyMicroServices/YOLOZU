...
\cmd{python3 tools/run\_reference\_adapter\_regression.py} & Runs RT-DETR reference-adapter regression with interface contract gates (hard) and behavior gates (warn/hard), including reproducibility metadata and optional lock/hash enforcement via \cmd{--runtime-lock}, \cmd{--enforce-runtime-lock}, and \cmd{--enforce-weights-hash}. \\
