...
\cmd{yolozu demo instance-seg-tta} & Real-image instance-seg TTA compare demo. Scans a small COCO polygon subset, applies a deterministic corruption, then writes raw-vs-hflip-TTA overlays under \path{demo\_output/instance\_seg\_tta/} or the chosen \cmd{--run-dir}. \\
