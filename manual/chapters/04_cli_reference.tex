...
\cmd{python3 tools/run\_reference\_adapter\_regression.py} & Runs RT-DETR reference-adapter regression gates (schema/consistency/metric/speed) against a pinned real-image baseline. \\
