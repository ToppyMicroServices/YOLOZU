...
\cmd{python3 tools/support\_ultralytics\_detr.py} & Ultralytics/DETR support utility with fixed 3-layer interface contract (trainer/repo/export), shared dataset conversion, ONNX export templates, and prediction canonicalization. \\
\bottomrule
\end{longtable}
