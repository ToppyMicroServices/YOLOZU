...
\begin{itemize}
  \item \cmd{train\_job}, \cmd{export\_onnx\_job}, \cmd{test\_job}, \cmd{ttt\_job}, \cmd{ctta\_job}
...
\begin{itemize}
  \item Auto-generate MCP/Actions tool reference from \path{yolozu.integrations.tool\_runner}.
  \item Add parity tests that assert MCP tool signatures and Actions request models stay aligned.
