...
\begin{itemize}
  ...
  \item Known runtime/input failures are persisted as \cmd{failed} with their captured error text for polling clients.
...
\begin{enumerate}
  ...
  \item Treat optional runtime probes and calibration metadata as best-effort; malformed numeric fields are skipped rather than aborting the entire request.
\end{enumerate}
