...
repository-owned qualifier and future execution outputs. It uses bounded manifests,
directory-relative no-follow mutation, and fail-closed recovery on POSIX. It does
not make a model adapter, selector, or image-processing execution path available,
and it does not silently weaken the guarantee
