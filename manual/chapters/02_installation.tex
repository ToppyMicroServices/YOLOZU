...
The installed Python API also exposes \cmd{ManagedOutputTransaction} for future
repository-owned qualifier and execution outputs. It uses bounded manifests,
directory-relative no-follow mutation, and fail-closed recovery on POSIX. It does
not add an image-processing command, and it does not silently weaken the guarantee
