...
command is installed. A code-owned Torchvision runner is registered, but the
Candidate records do not bind it, so the default invocation fails actionably
without dummy evidence. Its \cmd{--help} documents
