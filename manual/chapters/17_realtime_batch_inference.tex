...
\caption{Real-time vs batch inference share the same artifact boundary (\path{predictions.json}); optional extras must be explicitly budgeted.}
\end{figure}
...
\node[group, fit=(pre) (post) (logic), label={[align=left]above:Python/C++ glue}] {};
