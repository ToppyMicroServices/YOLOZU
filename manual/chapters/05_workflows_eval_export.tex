...
For a repo-bundled tiny sample that exercises \cmd{COCO -> YOLOZU -> YOLO/KITTI} end to end:
\begin{lstlisting}[language=bash]
yolozu migrate dataset   --from coco   --coco-root data/conversion_tiny_coco   --split val2017   --output reports/conversion_tiny_wrapper   --force
