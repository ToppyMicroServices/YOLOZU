...
The first real run is capped at ten images with a ten-minute operator stop
condition. This is a troubleshooting budget, not a performance guarantee.
Framework, model, hardware, and input sizes determine actual runtime.
...
order, preprocessing, score/NMS settings, bounding-box representation, and
protocol hash must also match.
