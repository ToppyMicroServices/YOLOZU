...
\begin{itemize}
  ...
  \item \cmd{smoke\_synthgen}: run a deterministic contract+overlay+eval smoke pass on \path{data/smoke/synthgen\_minishard}.
\end{itemize}

These tools reference the canonical SynthGen contract at \path{docs/synthgen_contract.md} and \path{schemas/synthgen_sample.schema.json}.
