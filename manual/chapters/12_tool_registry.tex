...
entrypoints. Chapter~18 owns the \emph{maintenance workflow}: changing tool
...
\begin{itemize}
  ...
  \item \textbf{Maintainer Action}: Use Chapter~18 to update the manifest, packaged copy, docs, and manual together.
...
Chapter~18. That chapter is the canonical update procedure for:
\begin{itemize}
